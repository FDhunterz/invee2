...
class PenjualanOnline extends StatefulWidget {
  PenjualanOnline({Key key, this.title}) : super(key: key);
  final String title;
  @override
  State<StatefulWidget> createState() {
    return _PenjualanOnlineState();
  }
}

class _PenjualanOnlineState extends State<PenjualanOnline> {
  int totalRefresh = 0;
