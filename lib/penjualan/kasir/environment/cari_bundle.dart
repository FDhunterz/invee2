...
class CariBundle extends StatefulWidget {
  final Produk bundle, selectedProduk;

  CariBundle({this.bundle, this.selectedProduk,});

  @override
  _CariBundleState createState() => _CariBundleState();
}

class _CariBundleState extends State<CariBundle> {
  int delayCari;
  Timer timer;
    ...
    try {
      final response = await http.post(
        ...
        body: {
          ...
          'id': widget.selectedProduk.idProduk,
        },
      );
  ...
  void initState() {
    ...
    _scanBarcode = null;
    getProduk();
    produkState = widget.bundle == null
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: isCari == true
              ...
              : Text(
                  'Tutup/Cap : ${produkState != null ? produkState.namaProduk : ''}'),
          actions: <Widget>[
            isCari == false
                ? IconButton(
                    onPressed: () async {
